...
export default function SignUp() {
  return (
    <>
      <View className="flex-1 bg-[#fff] px-[15px] pt-[100px] w-full">
        <View className="flex justify-between h-full pb-[50px]">
          ...
          <View className="flex gap-[20px]">
            <ThemedText className=" text-[#475467] text-[13px] font-[400]">
              ...
              <ThemedText className="text-[#101828] font-[500] underline" style={{ fontFamily:'SpaceGrotesk_500Medium'}}>
                {" "}
                Terms of Service{" "}
              </ThemedText>{" "}
              and{" "}
            ...
            <ThemedText className=" text-[#475467] text-[13px] font-[400]">
              ...
              <ThemedText className="text-[#101828] font-[500]" style={{ fontFamily:'SpaceGrotesk_500Medium'}}>
                dealer account
              </ThemedText>{" "}
              instead.
            </ThemedText>
