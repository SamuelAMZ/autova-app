      ...
      <ScrollView className="flex-1 bg-[#fff] px-[15px] pt-[100px]">
        <View className="items-start gap-[32px]">
          ...
          <View className="flex gap-[8px] items-start">
            <ThemedText className='text-[15px] text-[#070C0F]' >You are registering with <Text className="text-[#007AFF] underline" style={{ color:'#007AFF'}}>example@email.com</Text></ThemedText>
            <ThemedText className='text-[15px] text-[#070C0F]'>Want to change? <Text className="text-[#007AFF] underline" style={{ color:'#007AFF'}}> Click here </Text></ThemedText>
          </View>
          <View className="flex gap-[20px]">
            <View className="flex gap-4">
              ...
              <TextInput
                ...
                className="bg-[#EFEFEF] rounded-[12px] py-[16px] px-[20px]"
              />
              <ThemedText className='text-[#475467]'>* Your password should be minimum 8 characters.</ThemedText>
            </View>
            <CustomButton
